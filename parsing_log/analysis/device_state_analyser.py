...
class DeviceStateAnalyser(AbstractedDataAnalyser):
    ...
    def store(self) -> str:
        ...
        analysis = {'total_of_on_time':str(self.total_of_on_time),
                    'device_onoff_records':str(self.device_onoff_records),
                    'device_error_records':str(self.device_error_records)}
